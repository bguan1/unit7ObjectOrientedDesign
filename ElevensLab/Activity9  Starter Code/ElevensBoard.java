...
public class ElevensBoard extends Board {
    ...
    private boolean containsPairSum11(List<Integer> selectedCards) {
        ...
        while(i < selectedCards.size())
        {
            ...
            {
                 int m = selectedCards.get(i);
                 int n = selectedCards.get(j);
                 selectedCards.clear();
                 selectedCards.add(m);
                 selectedCards.add(n);
                 return true;
    ...
    private boolean containsJQK(List<Integer> selectedCards) {
        ...
        {
            temp.add(cardAt(selectedCards.get(i)).rank());
        }
        if( temp.contains("jack") && temp.contains("queen") && temp.contains("king"))
        {
            return true;
        }
        else
